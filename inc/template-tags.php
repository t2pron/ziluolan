...
if ( ! function_exists( 'ziluolan_entry_meta' ) ) :
    function ziluolan_entry_meta() {
        if ( 'post' == get_post_type() ) {

            $categories = get_the_category();
            if($categories){
                foreach($categories as $cat){
                    echo ' <a target="_blank" class="btn btn-default" href="'. get_category_link($cat->term_id )
                        .'">'. $cat->name .'</a> ';
                }
            }
            ...
            $tags = get_the_tags();
            if($tags){
                echo ' &nbsp <span class="tags-links"><span class="">  标签 </span>';
                foreach($tags as $tag){
                    echo '<a target="_blank" class="label label-info" href="'. get_tag_link($tag->term_id) . '">' . $tag->name . '</a> ';
                }
                echo '</span>';
            }
        }
